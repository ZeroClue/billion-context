...
- git_policy: commits approved 2026-09-20, reconfirmed 2026-09-25 — commit handoff docs (after `git mv`-ing older `docs/handoff-*.md` into `docs/archive/handoffs/`, mkdir -p first); origin = ZeroClue/billion-context fork (2026-09-25, main pushed) — push only on explicit user utterance, NEVER to upstream; report the commit hash
